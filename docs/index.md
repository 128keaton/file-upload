...
* [Prerequisites](#prerequisites)
    * [Development Environment Setup](#%2Adevelopment-environment-setup%2A)
* [Adding File Uploads](#adding-file-uploads)
    * [Step 1: Clone the GitHub Repo](#step-1%3A-clone-the-github-repo)
    * [Step 2: Switch to the main Branch](#step-2%3A-switch-to-the-%60main%60-branch)
    * [Step 3: Install the Ruby Gem Dependencies](#step-3%3A-install-the-ruby-gem-dependencies)
    * [Step 4: Install the JavaScript Dependencies](#step-4%3A-install-the-javascript-dependencies)
    * [Step 5: Initialize the Database](#step-5%3A-initialize-the-database)
    * [Step 6: Run the Development Web Server](#step-6%3A-run-the-development-web-server)
    * [Step 7: Generate the UploadedFile Model](#step-7%3A-generate-the-uploadedfile-model)
    * [Step 8: Attaching ActiveStorage to the UploadedFile Model](#step-8%3A-attaching-activestorage-to-the-uploadedfile-model)
    * [Step 9: Creating the UploadedFiles Controller](#step-9%3A-creating-the-uploadedfiles-controller)
    * [Step 10: Adding Helper Methods](#step-10%3A-adding-helper-methods)
    * [Step 11: Adding Routes](#step-11%3A-adding-routes)
    * [Step 12: Adding Controller Methods](#step-12%3A-adding-controller-methods)
    * [Step 13: Creating and Editing the View Templates](#step-13%3A-creating-and-editing-the-view-templates)
    * [Step 14: Installing Bootstrap](#step-14%3A-installing-bootstrap)
    * [Step 15: Adding Styling](#step-15%3A-adding-styling)
